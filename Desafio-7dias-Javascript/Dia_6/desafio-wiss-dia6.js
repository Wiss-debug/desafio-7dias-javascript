...
while(agregarMas != "no"){
    ...
    while (agregarMas != "si" && agregarMas != "no" && agregarMas != "eliminar") {  //mientras el texto leído sea diferente de "sí", "no" y "eliminar", mostrar que no fue reconocido y preguntar nuevamente
